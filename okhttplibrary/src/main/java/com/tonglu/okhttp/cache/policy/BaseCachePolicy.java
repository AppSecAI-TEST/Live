...
import com.tonglu.okhttp.db.CacheManager;
import com.tonglu.okhttp.exception.HttpException;
import com.tonglu.okhttp.model.Response;
import com.tonglu.okhttp.request.base.Request;
import com.tonglu.okhttp.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        OkHttpUtil.getInstance().getDelivery().post(run);
    }
