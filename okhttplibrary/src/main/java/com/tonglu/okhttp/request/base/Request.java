package com.tonglu.okhttp.request.base;

import android.text.TextUtils;

import com.tonglu.okhttp.OkHttpUtil;
import com.tonglu.okhttp.adapter.AdapterParam;
import com.tonglu.okhttp.adapter.CacheCall;
import com.tonglu.okhttp.adapter.Call;
import com.tonglu.okhttp.adapter.CallAdapter;
import com.tonglu.okhttp.cache.CacheEntity;
import com.tonglu.okhttp.cache.CacheMode;
import com.tonglu.okhttp.cache.policy.CachePolicy;
...
/**
 * ================================================
 * 描    述：所有请求的基类，其中泛型 R 主要用于属性设置方法后，
 * 返回对应的子类型，以便于实现链式调用
 * ================================================
 */
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        OkHttpUtil go = OkHttpUtil.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkHttpUtil.getInstance().getOkHttpClient();
