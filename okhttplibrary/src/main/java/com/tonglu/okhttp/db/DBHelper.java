...
import com.tonglu.okhttp.cookie.SerializableCookie;
import com.tonglu.okhttp.model.Progress;

class DBHelper extends SQLiteOpenHelper {

    private static final String DB_CACHE_NAME = "okhttp.db";
    ...
    DBHelper() {
        this(OkHttpUtil.getInstance().getContext());
    }
